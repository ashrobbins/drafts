...
<html>
    <head>
        <title>Add Post - Dash Admin</title>
    ...
    <body>
        <div id="container">
            ...
            <div class="row">
                <span class="page-title twelve columns">Add New Post</span>
            </div>
            ...
            <div id="main" class="row">
                    ...
                    <div class="post-md">
                        <span class="md-heading twelve columns">
                            ...
                            <div class="post-slug right">
                                <span>Slug: </span><input type="text" name="postSlug" class="edit-slug" value="new-post" />
                            </div>
                        </span>
                        <article class="post row">
                            ...
                            <div class="twelve columns post-body">
                                ...
                                <textarea>Type post content markdown here</textarea>
                            </div>
                        </article>
                    </div><!-- END .post-list -->
                </div>
                ...
                <div class="six columns right">
                    ...
                    <form method="POST" action="save-new-post.php">
                        <div class="edit-actions twelve columns">
                            <span class="html-heading">Live Preview</span>
                            <div class="buttons text-right">
                                <span>Publish date: </span><input type="text" name="postDate" class="edit-date" value="<?php echo date('d-m-Y'); ?>" />
