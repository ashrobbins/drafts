        ...
        <div id="container">
            ...
            <div id="main" class="row">
                ...
                <div class="four columns left">
                    <div class="post-list">
                        <span class="list-heading">Pages
                            <a href="add.php" class="right" title="Add a new page">Add New</a>
                        </span>
                        <?php
                            ...
                            <article class="post">
                                <a href="#" class="post-link row" id="<?php echo $id; ?>" title="Edit <?php echo $title; ?>" onclick="getPage(this.id)">
                                    <span class="ten columns">
                                        <h4 class="page-list-title"><?php echo $title; ?></h4>
                                    </span>
